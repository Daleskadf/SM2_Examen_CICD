...
class PublicarViajePage extends StatefulWidget {
  const PublicarViajePage({super.key});
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: Colors.grey.withAlpha((0.10 * 255).round()), blurRadius: 8)],
          ),
          padding: const EdgeInsets.all(18),
          child: Column(
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: Colors.purple.withAlpha((0.05 * 255).round()),
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: Colors.blue.withAlpha((0.05 * 255).round()),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10),
                            borderSide: BorderSide.none,
                          ),
